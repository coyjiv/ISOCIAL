  ...
  return (
    <>
      <Dialog scroll="paper" sx={{
        ...
        <BlueRoundedButton onClick={handleListItemClick} disabled={!postContent && postContent.length === 0}>{type === 'create' ? 'Create' : type === 'edit' ? 'Edit' : 'Share'} a post</BlueRoundedButton>
      </Dialog>
