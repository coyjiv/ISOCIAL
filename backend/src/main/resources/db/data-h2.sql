...
VALUES 
-- User 1
			('John', 'Doe', 'test@example.com', 'New York', '$2a$10$5OPwzIZ2N8CIeWUA2q9t0OzoI1kB7cvf1qDGwyxeiBFEAR3h2Psmu',
...
-- User 2
      ('Alice', 'Johnson', 'test2@example.com', 'Los Angeles', '$2a$10$5OPwzIZ2N8CIeWUA2q9t0OzoI1kB7cvf1qDGwyxeiBFEAR3h2Psmu', 
			ARRAY ['https://i.pravatar.cc/150?img=2'], 'https://picsum.photos/id/22/1200/350',
...
-- User 3
      ('Bob', 'Smith', 'bob.smith@example.com', 'Chicago', '$2a$10$5OPwzIZ2N8CIeWUA2q9t0OzoI1kB7cvf1qDGwyxeiBFEAR3h2Psmu', 
			ARRAY ['https://i.pravatar.cc/150?img=3'], 'https://picsum.photos/id/23/1200/350',
      'Bob Smith bio', 'MALE', FALSE, CURRENT_TIMESTAMP,
      '1992-07-08', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, true, false, null, null, 'OFFLINE'),
-- User 4
      ('Eva', 'Martinez', 'eva.martinez@example.com', 'San Francisco', 'securepass123',
...
-- User 5
      ('Michael', 'Williams', 'michael.williams@example.com', 'Miami', 'password123', 
			ARRAY ['https://i.pravatar.cc/150?img=14'], 'banner5.jpg',
      'Michaels bio', 'MALE', FALSE, CURRENT_TIMESTAMP,
      '1975-06-25', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, true, false, null, null, 'OFFLINE'),
-- User 6
      ('Sophia', 'Lee', 'sophia.lee@example.com', 'Seattle', 'strongpassword456', ARRAY [], 'banner6.jpg',
...
-- User 7
      ('Daniella', 'Brown', 'daniel.brown@example.com', 'Houston', 'password7', 
			ARRAY ['https://i.pravatar.cc/150?img=5'], 'https://picsum.photos/id/28/1200/350',
...
-- User 8
      ('Mia', 'Wilson', 'mia.wilson@example.com', 'Phoenix', 'password8', 
			ARRAY ['https://i.pravatar.cc/150?img=9'], 'https://picsum.photos/id/29/1200/350',
      'Mia Wilson bio', 'FEMALE', FALSE, CURRENT_TIMESTAMP,
      '1993-11-22', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, true, false, null, null, 'OFFLINE'),
-- User 9
      ('Liam', 'Jones', 'liam.jones@example.com', 'New York', 'password9', 
			ARRAY ['https://i.pravatar.cc/150?img=7'], 'https://picsum.photos/id/30/1200/350',
      'Liam Jones bio', 'MALE', FALSE, CURRENT_TIMESTAMP,
      '1982-08-17', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, true, false, null, null, 'OFFLINE'),
-- User 10
      ('Ava', 'Smith', 'ava.smith@example.com', 'New York', 'password10', 
			ARRAY ['https://i.pravatar.cc/150?img=10'], 'https://picsum.photos/id/31/1200/350',
      'Ava Smith bio', 'FEMALE', FALSE, CURRENT_TIMESTAMP,
      '1998-05-05', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, true, false, null, null, 'OFFLINE'),
-- User 11
      ('Olivia', 'Anderson', 'olivia.anderson@example.com', 'Los Angeles', 'password11', 
			ARRAY ['https://i.pravatar.cc/150?img=16'], 'https://picsum.photos/id/27/1200/350',
...
-- User 12
      ('Emily', 'Brown', 'emily.brown@example.com', 'Philadelphia', 'password12',
...
-- User 13
      ('William', 'Jones', 'william.jones@example.com', 'Philadelphia', 'password13',
...
-- User 14
      ('Olivia', 'Garcia', 'olivia.garcia@example.com', 'New York', 'password14',
...
-- User 15
      ('Daniel', 'Rodriguez', 'daniel.rodriguez@example.com', 'Phoenix', 'password15',
...
-- User 16
      ('Ava', 'Fernandez', 'ava.hernandez@example.com', 'Los Angeles', 'password16',
...
-- User 17
      ('Matthew', 'Lopez', 'matthew.lopez@example.com', 'San Diego', 'password17',
...
-- User 18
      ('Mia', 'Martinez', 'mia.martinez@example.com', 'New York', 'password18',
...
-- User 19
      ('James', 'Gonzalez', 'james.gonzalez@example.com', 'New York', 'password19',
...
-- User 20
      ('Alexander', 'Johnson', 'alexander.johnson@example.com', 'Houston', 'password20', 
			ARRAY [], 'https://picsum.photos/id/27/1200/350',
...
-- User 21
      ('Alex', 'Miller', 'alex.miller@example.com', 'Los Angeles', 'password21', 
			ARRAY ['https://i.pravatar.cc/150?img=4'], 'https://picsum.photos/id/27/1200/350',
      'Alex Millers bio', 'MALE', FALSE, CURRENT_TIMESTAMP,
      '1983-04-18', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, true, false, null, null, 'OFFLINE'),
-- User 22
      ('Chris', 'Wilson', 'chris.wilson@example.com', 'Dallas', 'password22', 
			ARRAY ['https://i.pravatar.cc/150?img=61'], 'https://picsum.photos/id/28/1200/350',
...
-- User 23
      ('Emma', 'Clark', 'emma.clark@example.com', 'New York', 'password23', 
			ARRAY ['https://i.pravatar.cc/150?img=43'], 'https://picsum.photos/id/29/1200/350',
...
-- User 24
      ('David', 'Turner', 'david.turner@example.com', 'Phoenix', 'password24', 
			ARRAY ['https://i.pravatar.cc/150?img=7'], 'https://picsum.photos/id/30/1200/350',
...
-- User 25
			('Olivia', 'Brown', 'olivia.brown@example.com', 'Dallas', 'password25', 
			ARRAY ['https://i.pravatar.cc/150?img=45'], 'https://picsum.photos/id/28/1200/350',
...
-- User 26
			('Daniel', 'Clark', 'daniel.clark@example.com', 'Denver', 'password26', 
			ARRAY ['https://i.pravatar.cc/150?img=6'], 'https://picsum.photos/id/29/1200/350',
...
-- User 27
			('Emma', 'Ward', 'emma.ward@example.com', 'Phoenix', 'password27', 
			ARRAY ['https://i.pravatar.cc/150?img=48'], 'https://picsum.photos/id/30/1200/350',
      'Emma Wards bio', 'FEMALE', FALSE, CURRENT_TIMESTAMP,
      '1993-02-14', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, true, false, null, null, 'OFFLINE'),
-- User 28
			('Olivia', 'Bowie', 'olivia.bowie@example.com', 'New York', 'password28', 
			ARRAY ['https://i.pravatar.cc/150?img=23'], 'https://picsum.photos/id/28/1200/350',
...
-- User 29
			('Daniel', 'Garcia', 'daniel.garcia@example.com', 'New York', 'password29', 
			ARRAY ['https://i.pravatar.cc/150?img=13'], 'https://picsum.photos/id/29/1200/350',
...
-- User 30
			('Emily', 'Taylor', 'emily.taylor@example.com', 'Phoenix', 'password30', 
			ARRAY ['https://i.pravatar.cc/150?img=40'], 'https://picsum.photos/id/30/1200/350',
...
VALUES 
			(1, 1, 'POST', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
VALUES
-- friends of John Doe
			(4, 1, 'FRIEND', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
			(11, 1, 'FRIEND', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
			(12, 1, 'FRIEND', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
			(13, 1, 'FRIEND', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
			(14, 1, 'FRIEND', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
      (3, 1, 'REQUEST_SENT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
      (6, 1, 'REQUEST_SENT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
      (15, 1, 'REQUEST_SENT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
      (16, 1, 'REQUEST_SENT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
      (17, 1, 'REQUEST_SENT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
      (18, 1, 'REQUEST_SENT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
      (19, 1, 'REQUEST_SENT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
      (20, 1, 'REQUEST_SENT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
      (24, 1, 'REQUEST_SENT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
      (25, 1, 'REQUEST_SENT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
      (27, 1, 'REQUEST_SENT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
      (29, 1, 'REQUEST_SENT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
      (30, 1, 'REQUEST_SENT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
-- friends of Alice Johnson
			(11, 2, 'FRIEND', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
			(12, 2, 'FRIEND', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
			(13, 2, 'FRIEND', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
			(14, 2, 'FRIEND', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
			(16, 2, 'REQUEST_SENT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
			(17, 2, 'REQUEST_SENT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
			(18, 2, 'REQUEST_SENT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
			(19, 2, 'REQUEST_SENT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
-- friends of Emily Brown
			(7, 12, 'FRIEND', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
			(9, 12, 'FRIEND', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
			(15, 12, 'FRIEND', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE);
