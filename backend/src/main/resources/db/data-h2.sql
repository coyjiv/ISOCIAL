...
INSERT INTO public.posts (text_content, attachments, is_edited, user_id, creation_date, last_modified_date, is_active)
VALUES ('Post by user 4, no attachments here.', ARRAY [], FALSE, 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
       ('Another content piece by user 4, without attachments.', ARRAY [], FALSE, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE);
...
VALUES ('User 2 sharing a post with an image.',
        ...
        CURRENT_TIMESTAMP, TRUE),
       ('A post by user 5 with several images.',
