INSERT INTO public.users ( first_name, last_name, email, city, password, avatars_url, banner_url, bio, birth_place, study_place,
                          is_private, last_seen, activity_status, gender, date_of_birth, creation_date, last_modified_date,
                          is_premium, premium_nickname, premium_emoji, is_active)
VALUES ('John', 'Doe', 'test@example.com', 'New York',
        '$2a$10$5OPwzIZ2N8CIeWUA2q9t0OzoI1kB7cvf1qDGwyxeiBFEAR3h2Psmu', ARRAY ['https://sm.ign.com/ign_nordic/cover/a/avatar-gen/avatar-generations_prsz.jpg'], 'banner.jpg',
        'A short bio about John Doe', 'Lviv', 'Cambridge', FALSE, CURRENT_TIMESTAMP, 'OFFLINE', 'NOT_SPECIFIED', '1990-02-1', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, null, null, true);
...
VALUES ('Alice', 'Johnson', 'test2@example.com', 'Los Angeles',
        ...
        'Bio for Alice Johnson', 'Kyiv', 'Cambridge', FALSE, CURRENT_TIMESTAMP, 'OFFLINE', 'MALE', '1990-02-7', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, null, null, true);
...
VALUES ('Bob', 'Smith', 'bob.smith@example.com', 'Chicago',
        'mypassword', ARRAY ['https://sm.ign.com/ign_nordic/cover/a/avatar-gen/avatar-generations_prsz.jpg'], 'banner3.jpg',
        'Bob Smith bio', 'Lviv', 'Harvard', FALSE, CURRENT_TIMESTAMP, 'OFFLINE', 'MALE', '1990-01-29', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, null, null, true);
...
INSERT INTO public.users (first_name, last_name, email, city, password, avatars_url, banner_url, bio, birth_place, study_place,
                          is_private, last_seen, activity_status, gender, date_of_birth, creation_date, last_modified_date,
                          is_premium, premium_nickname, premium_emoji, is_active)
VALUES ('Eva', 'Martinez', 'eva.martinez@example.com', 'San Francisco',
        'securepass123', ARRAY ['https://sm.ign.com/ign_nordic/cover/a/avatar-gen/avatar-generations_prsz.jpg'], 'banner4.jpg',
        'Evas bio description', 'Lviv', Cambridge, FALSE, CURRENT_TIMESTAMP, 'OFFLINE', 'MALE', '1980-02-1', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false, null, null, true);
...
VALUES ('Michael', 'Williams', 'michael.williams@example.com', 'Miami', 'password123', ARRAY ['https://sm.ign.com/ign_nordic/cover/a/avatar-gen/avatar-generations_prsz.jpg'], 'banner5.jpg',
        'Michaels bio', 'Miami', 'University of Miami', FALSE, CURRENT_TIMESTAMP, 'OFFLINE', 'MALE',
        '1990-02-1', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, true, false, null, null);
...
INSERT INTO public.users (first_name, last_name, email, city, password, avatars_url, banner_url, bio, birth_place, study_place,
                          is_private, last_seen, activity_status, gender, date_of_birth, creation_date, last_modified_date,
                          is_premium, premium_nickname, premium_emoji, is_active)
VALUES ('Sophia', 'Lee', 'sophia.lee@example.com', 'Seattle', 'strongpassword456', ARRAY[]::VARCHAR[], 'banner6.jpg',
        'Sophias bio information', 'Seattle', 'University of Washington', FALSE, CURRENT_TIMESTAMP, 'OFFLINE', 'FEMALE',
        '1995-09-10', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, true, false, null , null);
...
INSERT INTO public.friends (requester_id, addresser_id, status, creation_date, last_modified_date, is_active)
VALUES (6, 1, 'FRIEND', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE);
INSERT INTO public.friends (requester_id, addresser_id, status, creation_date, last_modified_date, is_active)
VALUES (1, 5, 'FRIEND', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE);
