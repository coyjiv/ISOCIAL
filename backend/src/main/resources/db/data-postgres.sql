...
VALUES ('John', 'Doe', 'test@example.com', 'New York', '$2a$10$5OPwzIZ2N8CIeWUA2q9t0OzoI1kB7cvf1qDGwyxeiBFEAR3h2Psmu',
        ARRAY ['https://sm.ign.com/ign_nordic/cover/a/avatar-gen/avatar-generations_prsz.jpg'], 'banner.jpg',
...
VALUES ('This is a post by user 1 with no attachments.', ARRAY []::VARCHAR[], FALSE, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
       ('Another post by user 1, still no attachments here.', ARRAY []::VARCHAR[], FALSE, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE);
...
INSERT INTO public.posts (text_content, attachments, is_edited, user_id, creation_date, last_modified_date, is_active)
VALUES ('Post by user 2, no attachments here.', ARRAY []::VARCHAR[], FALSE, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
       ('Another content piece by user 2, without attachments.', ARRAY []::VARCHAR[], FALSE, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE);
